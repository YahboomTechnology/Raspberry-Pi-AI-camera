...
#Provide a csv file, the QR code content can be displayed on the screen and asave it to a special file.
...
#Command of using web Raspberry Pi's own camera 
...
while True:
    ...
    for barcode in barcodes:
        ...
        #Decode the contents of the QR code, enter the time, content and type
